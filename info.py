...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8252482448').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001855645227 -1001769437975 -1002754048161 -1002294594986').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002732889236'))
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002732889236'))
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002725001209'))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002463332367').split()]
AUTH_CHANNELS = [int(ch) for ch in environ.get("AUTH_CHANNELS", "-1002779576540").split() if ch and id_pattern.match(ch)]
...
GROUP_LINK = environ.get('GROUP_LINK', 'https://t.me/movie_seriesgroup')
...
UPDATE_CHANNEL = int(environ.get('UPDATE_CHANNEL', '-1002714455064'))
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002800489154'))
...
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/how_to_open_link_ak/27")
...
SHORTENER_API3 = environ.get("SHORTENER_API3", "a236cdf68649bcdf6eaba5f1119eacac803ba4eb")
